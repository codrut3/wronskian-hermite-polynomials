...
# partitions (N), (N, 1), (N, 2), where N <= 1000 or N is part of
...
to_check = list(range(1, 1003))
to_check.extend([2400, 2401, 2402, 2403, 2404, 4095, 4096, 4097, 4374, 4375, 4376, 4377, 4378, 7202, 7203, 7204, 13124, 13125, 13126])
for n in to_check:
  if n%10 == 0:
    print(n)
  partition_list = Partitions(n, max_length=2, outer=[oo, 2]).list()
